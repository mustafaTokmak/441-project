...
train_size = 200
test_size = 200
def get_test_and_train_sample_with_k_means(data_dict,subject,train_size,test_size,k):
    first_data_size  = 5
    train = []
    test = []
...
for key in data_dict.keys():
    ...
    train = []
    test = []
    test,train = get_test_and_train_sample_with_k_means(data_dict,key,train_size,test_size,1)
